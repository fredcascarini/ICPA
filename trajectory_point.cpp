...
bool trajectory_point::bound(const set_of_trajectories* ST, coord_set* CS) {
	return ST->test_bound(CS->return_atoms(), *max_element(Coordinates.begin(), Coordinates.end()) );
}
